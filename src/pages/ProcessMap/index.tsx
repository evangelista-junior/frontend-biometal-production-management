...
const ProcessMap = () => {
  ...
  const [filteredRoutines, setFilteredRoutines] = useState<[(number & string)[]] | null>(
    null
  );
    ...
    <C.Container>
      <C.Filters>
        ...
        <C.FilterLabel>
          ...
          <C.FilterSelect defaultValue={currentLayout} onChange={handleChangeLayout}>
            <C.FilterSelectOption value="null">TODAS ROTINAS</C.FilterSelectOption>
            {registeredLayouts
